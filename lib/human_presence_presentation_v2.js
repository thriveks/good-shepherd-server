  ...
  for (
    ...
    if (
      ...
      if (stationaryGate !== null) {
        metrics.push({
          label: "Stationary dominant gate",
      ...
      sections.push({
        ...
        headline:
          stateId
            ...
            : "An anonymous spatial state has been learned",
        detail:
    ...
    if (
      ...
      sections.push({
        ...
        headline:
          transitionPairs > 0
            ? "Good Shepherd is learning recurring states and transitions"
            : "Good Shepherd is learning persistence in the current state",
        detail:
          transitionPairs > 0
            ? "Anonymous spatial states are being compared in chronological evidence order to learn which patterns recur and which transitions actually occur."
            : "The current evidence has remained in the same anonymous state. No distinct state transition is being claimed until one is actually observed.",
        state: "learning",
        systemImage:
