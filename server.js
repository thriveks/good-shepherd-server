...
async function initializeDatabase() {
  ...
  // Human Presence Episode Profile Analysis v1 analytical persistence.
  // Observer-only Schema 1.1 physical episode-profile analytics.
  await ensureHumanPresenceEpisodeProfileAnalysisTableV1(pool);
